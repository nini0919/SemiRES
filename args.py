...
def get_parser():
    ...
    parser.add_argument('--sup_percent',help='the percent of labeled data')
    parser.add_argument('--unsup_percent',help='the percent of unlabeled data')
    parser.add_argument('--unsup_lambda',default=1,type=int,help='the weight of unsup loss')
    parser.add_argument('--ema_rate',default=0.9996,help='the ema_rate in EMA')
    parser.add_argument('--sam_type',default='vit_h',help='sam_type')
    parser.add_argument('--sam_checkpoint',default="segment-anything/sam_vit_h_4b8939.pth",help='')
    parser.add_argument('-s', '--seed', default=0, type=int, metavar='N', help='number of data loading workers')
    parser.add_argument('-p', '--p', default=5, type=int, metavar='N', help='number of data loading workers')
    parser.add_argument('--burn_in_ckpt',default="./output/1%/refcoco/sup/model_best_refcoco.pth")
